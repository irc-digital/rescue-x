...
class ReachThroughMediaImageAttributesField extends MediaImageAttributesField {
   ...
   */
  public function __construct($configuration, $plugin_id, $plugin_definition, EntityTypeManagerInterface $entity_type_manager, LinkGeneratorInterface $link_generator, AccountInterface $current_user, ReachThroughServiceInterface $reachThroughService) {
