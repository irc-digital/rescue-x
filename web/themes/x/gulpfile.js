...
config.styles = {
  max_file_size: '150000', // this is a bit of a safety valve - edge this up to protect us from bad includes or bad CSS blowing up our file size
...
gulp.task('build:styles:canvas_colors', function () {
  ...
  fs.writeFileSync(config.patternLab.dir + '/source/scss/base/_canvas-color.autogenerated.scss', "");

  var canvas_color_type = ['brand', 'neutral'];

  for (var i = 0; i < canvas_color_type.length; i++) {
    var color_css = get_canvas_colors(canvas_color_type[i]);
